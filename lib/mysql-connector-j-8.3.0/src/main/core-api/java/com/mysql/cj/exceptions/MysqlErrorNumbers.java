...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_TOO_MANY_USER_CONNECTIONS = 1203; //SQLSTATE: 42000 Message: Model.User %s already has more than 'max_user_connections' active connections
    ...
    public final static int ER_USER_LIMIT_REACHED = 1226; //SQLSTATE: 42000 Message: Model.User '%s' has exceeded the '%s' resource (current value: %ld)
    ...
    public final static int ER_NOT_SUPPORTED_AUTH_MODE = 1251; //SQLSTATE: 08004 Message: Model.Client does not support authentication protocol requested by server; consider upgrading MySQL client
